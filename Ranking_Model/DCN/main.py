...
def main(args):
    ...
    # 模型初始化
    model = DCN(sparse_fea_list, len(args.num_features), args.embed_dim, args.hidden_layer_list, args.layer_num).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--layer_num', type=int, default=1, help='目标列名称')
    ...
    parser.add_argument('--model_name', type=str, default='DCN', help='模型名称')
